...
initProgress(){
    ...
    echo "Import modified database and default problem data - by tzs 2022.12.12"
    #Import MySQL database
    service mysql restart
    echo "DROP DATABASE IF EXISTS app_uoj233;" | mysql -u root --password=$_database_password_
    mysql -u root --password=$_database_password_ < /opt/uoj/install/bundle/app_uoj233.sql
    #Copy problem data
